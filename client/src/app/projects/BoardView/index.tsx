          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://managed-s3-images.s3.eu-central-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://managed-s3-images.s3.eu-central-1.amazonaws.com/${task.author.profilePictureUrl!}`}
